...
business_features = "For a user-defined star level or range, you can see the following business categories:\n" + \
           ...
           "  prices: breakdown of price levels\n" + \
...
user_features = "For a user-defined star level or range, you can see the following user categories:\n" + \
                "fans - the average number of fans that users have\n" + \
                "yelping_since - the number proportion of users that have yelped since a given year\n" + \
                "review_count - the average number of reviews that users have given\n" + \
                "votedUseful - box plot showing distribution of 'Useful' votes received by users\n" + \
                "votedFunny - box plot showing distribution of 'Useful' votes received by users\n" + \
                "votedCool - box plot showing distribution of 'Useful' votes received by users"
